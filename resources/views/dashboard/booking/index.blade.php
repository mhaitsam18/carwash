        ...
        <div class="card">
            <div class="card-body">
                <form action="/booking" method="post" enctype="multipart/form-data">
                    ...
                    <a href="https://api.whatsapp.com/send?phone=6282215144057&text=Saya%20Butuh%20Bantuan" class="btn btn-success" target="_blank"><i class="fa-brands fa-whatsapp"></i> Chat WhatsApp</a>
                </form>
